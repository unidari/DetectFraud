...
class DataLoader:
    SYNONYMS = {
        'дебет': [
            ...
            'дебетовое сальдо', 'дебетовый счет', 'dt_acc', 'debit_account', 'дебет_счета', 'счет_дебет', 'сумма списания',
            'плательщиксчет'
        ],
        'кредит': [
            'кредит', 'credit', 'кт', 'ct', 'кредит сч', 'кредитовый', 'кредит счета', 'кредит счёт',
            'кредитовое сальдо', 'кредитовый счет', 'ct_acc', 'credit_account', 'кредит_счета', 'счет_кредит', 'получательсчет',
            'сумма поступления'
        ],
        'сумма': [
